...
render() { local out; out=$(mktemp); sed -e "s#image: flink:2.2#image: flink:${FLINK_VERSION}#" -e "s#flinkVersion: v2_2#flinkVersion: v${FLINK_VERSION/./_}#" -e "s#name: example#name: $2#" -e "s#sources: e2e-in#sources: $2#" "$1" > "$out"
